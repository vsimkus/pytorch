...
def get_testing_overrides():
    ...
    return {
        ...
        torch.clamp_with_tensors: lambda input, min, max, out=None: -1,
        torch.clamp_with_tensors_min: lambda input, min, out=None: -1,
        torch.clamp_with_tensors_max: lambda input, max, out=None: -1,
